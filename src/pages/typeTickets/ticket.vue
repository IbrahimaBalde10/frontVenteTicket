...
import statistique from '../typeTickets/specificites/CardStatisticsVertical.vue'
...
const tabs = [
  ...
  },
  {
    title: 'Tickets',
    icon: 'bx-user',
    tab: 'TicketManagement',
  },
   {
    title: 'Dashboards',
    icon: 'bx-user',
    tab: 'DashboardManagement',
  },
   {
    title: 'statistique',
    icon: 'bx-user',
...
<template>
  <div>
    ...
    >
     ...
     <!-- DashboardManagement -->
      <VWindowItem value="DashboardManagement">
        <DashboardManagement />
      </VWindowItem>
