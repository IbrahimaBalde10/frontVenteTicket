      ...
      <VRow>
        <VCol cols="9">
          <VCard class="text-2xl font-weight-bold p-4">
            <VCardTitle class="text-2xl font-weight-bold">Liste des administrateurs</VCardTitle>
          </VCard>
        </VCol>
        <VCol cols="3">
...
const allUsers = computed(() => store.getters['users/allUsers'].filter(user => user.role === 'Admin'));
